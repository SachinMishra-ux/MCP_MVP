...
from mcp_client.sse_adapter import SSEAdapter  # ✅ NEW
        ...
        for name, server_config in servers.items():
            try:
                ...
                if url:
                    ...
                    print(f"[{name}] Using internal SSE Adapter")

                    adapter = SSEAdapter(url, headers=headers)
                    ...
                    print(f"Connected to {name} via SSE successfully.")
                    continue
